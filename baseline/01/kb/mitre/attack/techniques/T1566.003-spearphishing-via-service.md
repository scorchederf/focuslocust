...
tags:
    ...
    - platform/macos
    - platform/windows
mitre-attack: kb/mitre/attack/techniques/T1566.003-spearphishing-via-service
tactic:
    - Initial Access
platforms:
    - Linux
...
| ID | Name | Use |
| --- | --- | --- |
| [S1100](https://attack.mitre.org/software/S1100) | Ninja | Ninja has been distributed to victims via the messaging app Telegram.[^1]  |

## Mitigations
| ID | Name | Description |
| --- | --- | --- |
| [[kb/mitre/attack/mitigations/M1017-user-training\|M1017]] | User Training | Users can be trained to identify social engineering techniques and spearphishing messages with malicious links. |
| [[kb/mitre/attack/mitigations/M1018-user-account-management\|M1018]] | User Account Management | Enforce strict user account management policies on third-party service accounts to control access and limit privileges. Configure accounts with the minimum permissions necessary to perform their roles and regularly review access levels. This minimizes the risk of adversaries exploiting service accounts to execute spearphishing attacks or gain unauthorized access to sensitive resources. |
