...
tags:
    ...
    - platform/macos
    - platform/windows
mitre-attack: kb/mitre/attack/techniques/T1048.002-exfiltration-over-asymmetric-encrypted-non-c2-protocol
tactic:
    - Exfiltration
platforms:
    - ESXi
...
| ID | Name | Use |
| --- | --- | --- |
| [S0483](https://attack.mitre.org/software/S0483) | IcedID | IcedID has exfiltrated collected data via HTTPS.[^1]  |
| [[kb/mitre/attack/software/S1040-rclone\|S1040]] | Rclone | [[kb/mitre/attack/software/S1040-rclone\|Rclone]] can exfiltrate data over SFTP or HTTPS via WebDAV.[^1]  |
| [S9011](https://attack.mitre.org/software/S9011) | BRUSHFIRE | BRUSHFIRE has the ability to exfiltrate data on-demand through executing commands obtained via monitoring for specially crafted packets and sending output back in an embedded SSL response.[^1]  |
