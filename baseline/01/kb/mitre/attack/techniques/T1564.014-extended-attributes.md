...
tags:
    ...
    - platform/linux
    - platform/macos
mitre-attack: kb/mitre/attack/techniques/T1564.014-extended-attributes
tactic:
    - Stealth
platforms:
    - Linux
...
| ID | Name | Description |
| --- | --- | --- |
| [[kb/mitre/attack/mitigations/M1040-behavior-prevention-on-endpoint\|M1040]] | Behavior Prevention on Endpoint | During artifact review, packaging, or deployment stages, scan extended attributes alongside file contents to detect hidden payloads, obfuscated data, or suspicious attribute keys that may indicate malicious behavior. |

 [^1]: [Establishing persistence using extended attributes on Linux](https://kernal.eu/posts/linux-xattr-persistence/)
 [^2]: [Low GroupIB xattrs nov 2024](https://www.group-ib.com/blog/stealthy-attributes-of-apt-lazarus/)
