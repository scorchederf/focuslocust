...
tags:
    ...
    - platform/windows
mitre-attack: kb/mitre/attack/techniques/T1556.001-domain-controller-authentication
tactic:
    - Credential Access
    - Defense Impairment
    - Persistence
...
| ID | Name | Use |
| --- | --- | --- |
| [S0007](https://attack.mitre.org/software/S0007) | Skeleton Key | Skeleton Key is used to patch an enterprise domain controller authentication process with a backdoor password. It allows adversaries to bypass the standard authentication system to use a defined password for all accounts authenticating to that domain controller.[^1]  |
...
| [[kb/mitre/attack/mitigations/M1032-multi-factor-authentication\|M1032]] | Multi-factor Authentication | Integrating multi-factor authentication (MFA) as part of organizational policy can greatly reduce the risk of an adversary gaining control of valid credentials that may be used for additional tactics such as initial access, lateral movement, and collecting information. MFA can also be used to restrict access to cloud resources and APIs.  |
 ...
 [^1]: [Dell Skeleton](https://www.secureworks.com/research/skeleton-key-malware-analysis)
 ...
 [^5]: [Microsoft LSA](https://technet.microsoft.com/en-us/library/dn408187.aspx)
