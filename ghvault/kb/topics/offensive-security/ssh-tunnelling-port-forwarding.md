...
![](<../../_assets/ssh-remote-exposed.png>)
...
![](<../../_assets/ssh-dynamic-port-forwarding-myip1.png>)
...
![](<../../_assets/ssh-dynamic-port-forwarding-create-tunel.png>)

Checking network connections on the localhost 10.0.0.5, we can see that the port 9090 is now listening:

![](<../../_assets/ssh-dynamic-port-forwarding-port-listening.png>)
...
[source record](../../sources/redteamingtactics/ssh-tunnelling-port-forwarding.md)
