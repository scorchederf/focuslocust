...
![Vulnerable program crashes when the garbage is fed to it, but the RIP is not overwritten](<../../../_assets/image (902).png>)
...
![RIP offset is 104](<../../../_assets/image (898).png>)
...
![104 bytes of garbage before we can place an arbitrary RIP value on the stack](<../../../_assets/image (903).png>)
...
![We can now control RIP as it points to 0x0000414141414141](<../../../_assets/image (899).png>)
...
![PWN environment variable location on the stack in the vulnerable program](<../../../_assets/image (900).png>)
...
![Vulnerable program is exploited and results in a new shell](<../../../_assets/x64-stack-overflow (1).gif>)
...
![Exploit no longer works since shellcode is gone from the PWN environment variable](<../../../_assets/image (901).png>)
...
[source record](../../sources/redteamingtactics/64-bit-stack-based-buffer-overflow.md)
