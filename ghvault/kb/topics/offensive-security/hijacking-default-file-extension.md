...
When a .txt file is double clicked, it's opened with a notepad.exe. Windows knows that it needs to use notepad.exe for opening txt files, because the .txt extension (among many others) are mapped to applictions that can open those files in
...
![](<../../_assets/hijacked-extension.gif>)
...
[source record](../../sources/redteamingtactics/hijacking-default-file-extension.md)
