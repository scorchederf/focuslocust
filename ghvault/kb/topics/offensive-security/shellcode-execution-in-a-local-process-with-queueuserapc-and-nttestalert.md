...
This is a quick lab that shows how to execute shellcode within a local process by leveraging a Win32 API QueueUserAPC and an officially undocumented Native API NtTestAlert, which lands in kernel that calls KiUserApcDispatcher if the APC que
...
```
![](<../../_assets/Annotation 2019-05-27 191650.png>)
...
![](<../../_assets/Annotation 2019-05-27 192952.png>)
...
[source record](../../sources/redteamingtactics/shellcode-execution-in-a-local-process-with-queueuserapc-and-nttestalert.md)
