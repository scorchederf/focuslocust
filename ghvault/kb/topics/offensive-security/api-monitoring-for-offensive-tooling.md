...
Rio Sherri recently posted about his tool RdpThief which I thought was plain genius. It allows for offe
...
![](<../../_assets/image (227).png>)

..we are prompted to enter credentials:

![RDP authentication prompt](<../../_assets/image (34).png>)
...
![CredIsMarshaledCredentialW contains the string spotless](<../../_assets/image (113).png>)
...
![ADVAPI32!CredIsMarshaledCredentialW breakpoint hit and username printed - still](<../../_assets/image (168).png>)
...
![32 byte encrypted binary blob](<../../_assets/image (150).png>)
...
![RDP credentials get intercepted and written to a file](<../../_assets/inject-rdp-thief.gif>)
...
![](<../../_assets/inject-rdp-thief-credreadw.gif>)
...
[source record](../../sources/redteamingtactics/api-monitoring-for-offensive-tooling.md)
