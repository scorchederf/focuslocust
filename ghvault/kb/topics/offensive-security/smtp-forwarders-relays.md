...
![](<../../_assets/smtp-relay-droplet.png>)
...
![A record pointing to the droplet IP](<../../_assets/smtp-relay-maila.png>)

![](<../../_assets/smtp-relay-mx.png>)
...
![](<../../_assets/smtp-relay-test-mail.png>)
...
![](<../../_assets/smtp-relay-first-email.png>)
...
![](<../../_assets/smtp-relay-relay-access-denied.png>)

Once the relay issue is solved, we can repeat the test and see a successful relay:

![](<../../_assets/smtp-relay-gmail-phish.png>)

This time the headers look like so:

![](<../../_assets/smtp-relay-headers-relayed.png>)
...
![](<../../_assets/smtp-relay-header-checks.png>)
...
![](<../../_assets/smtp-relay-removed-traces.png>)

![](<../../_assets/smtp-relay-removed-traces2.png>)
...
[source record](../../sources/redteamingtactics/smtp-forwarders-relays.md)
