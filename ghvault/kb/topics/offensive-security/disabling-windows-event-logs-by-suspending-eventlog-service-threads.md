...
This lab was inspired by an old post Phant0m: Killing Windows Event Log by @hlldz where he introduced a powershell tool Invoke-Phant0m
...
![](<../../_assets/demo-suspending-eventlog-threads (1).gif>)
...
[source record](../../sources/redteamingtactics/disabling-windows-event-logs-by-suspending-eventlog-service-threads.md)
