...
In this short lab I am going to use a WinDBG to make my malicious program pretend to look like a notepad.exe (hence masquerading) when inspecting system's running processes with tools like Sysinternals ProcExplorer and similar. Note that th
...
![](<../../_assets/Screenshot from 2018-10-23 23-36-52.png>)
...
![](<../../_assets/Screenshot from 2018-10-23 19-47-59.png>)
...
![](<../../_assets/Screenshot from 2018-10-23 20-02-49.png>)
...
[source record](../../sources/redteamingtactics/masquerading-processes-in-userland-via-peb.md)
