...
```
![GAL successfully dumped](<../../_assets/Screenshot from 2019-01-15 18-58-46.png>)
...
![](<../../_assets/Screenshot from 2019-01-15 20-16-39.png>)

It is then passed to `FindPeople` API:

![](<../../_assets/Screenshot from 2019-01-15 20-21-13.png>)

...which in turn retrieves a JSON object with contacts from the GAL

![](<../../_assets/Screenshot from 2019-01-15 19-03-13.png>)

If you are interested in the JSON only (most likely), just switch to the Response tab:

![](<../../_assets/Screenshot from 2019-01-15 20-12-57.png>)
...
```
![](<../../_assets/Screenshot from 2019-01-15 19-26-46.png>)
...
[source record](../../sources/redteamingtactics/dump-gal-from-owa.md)
