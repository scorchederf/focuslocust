...
I first learned about ProcessDynamicCodePolicy in Adam Chester's great post https://blog.xpnsec.com/protecting-your-malware/ and this is a quick lab to play ar
...
![mitigationpolicy.exe is running with ACG policy enabled](<../../_assets/image (490).png>)
...
![ACG prevents dynamic code execution, shellcode not executed](<../../_assets/acg-on.gif>)
...
![shellcode is executed and reverse shell is returned](<../../_assets/acg-off.gif>)

...procmon shows that `injectorDllShellcode.dll` was loaded this time:

![](<../../_assets/image (492).png>)
...
![once injector is run against mitigationpolicy.exe, shellcode is executed](<../../_assets/image (491).png>)
...
[source record](../../sources/redteamingtactics/processdynamiccodepolicy-arbitrary-code-guard-acg.md)
