...
![We need to make sure the overflowed stack looks like this](<../../../_assets/image (954).png>)
...
![Payload structure visualized](<../../../_assets/image (969).png>)
...
![Key function addresses to be used in the payload](<../../../_assets/image (919).png>)

Having found the function addreses, our payload visualization can now be updated like this:

![Payload structure with ROP function addresses](<../../../_assets/image (967).png>)
...
![EIP offset](<../../../_assets/image (921).png>)
...
![Payload structure with correct EIP offset and ROP function addresses](<../../../_assets/image (970).png>)
...
![1st ROP chain in action](<../../../_assets/rop-chain-exploit.gif>)
...
![Stack layout during vulnerable function's execution](<../../../_assets/image (958).png>)
...
![rop1 is about to return, pop the rop2 address from the stack and jump to it](<../../../_assets/image (926).png>)
...
![rop2 is about to return, pop the rop3 address from the stack and jump to it](<../../../_assets/image (927).png>)
...
![rop3 is about to return, pop the exit address from the stack and jump to it](<../../../_assets/image (928).png>)
...
![Required stack layout for our 2nd ROP chain](<../../../_assets/image (959).png>)
...
![ropgadgets in rop1b vulnerable program](<../../../_assets/image (931).png>)
...
![popret ROP gadget instructions](<../../../_assets/image (935).png>)
...
![rop1, rop2, rop3 and exit function addresses inside rop1b vulnerable program](<../../../_assets/image (941).png>)

Let's also note the `popret` and `pop2ret` gagdet addresses:

![ROP gadget addresses for rop1b vulnerable program](<../../../_assets/image (942).png>)
...
![Visualized payload for the 2nd ROP chain](<../../../_assets/image (963).png>)
...
![2nd ROP chain with arguments and rop gadgets works as expected](<../../../_assets/rop-chain-exploit-with-popret.gif>)
...
![Inspecting the stack layout](<../../../_assets/pop-pop-ret-inspection.gif>)
...
![ROP chains executed successfully](<../../../_assets/image (965).png>)
...
[source record](../../sources/redteamingtactics/rop-chaining-return-oriented-programming.md)
