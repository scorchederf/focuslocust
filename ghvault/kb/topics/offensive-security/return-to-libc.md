...
![High level overview of ret-to-libc technique for a 32-bit vulnerable program](<../../../_assets/image (834).png>)
...
![Vulnerable program compiled](<../../../_assets/image (836).png>)
...
![Temporarily disable ASLR](<../../../_assets/image (857).png>)
...
![Spawn vulnerable program with gdb, getting our hands dirty](<../../../_assets/image (851).png>)
...
![Protections overview for the vulnerable program](<../../../_assets/image (837).png>)
...
![system\(\) is located at 0xb7e13870](<../../../_assets/image (839).png>)

## Finding exit\(\)

The same way, we can see that `exit()` resides at `0xb7e06c30`:

![exit\(\) is located at 0xb7e06c30](<../../../_assets/image (847).png>)
...
![Inside the vulenerable program, libc is loaded at 0xb7dd6000](<../../../_assets/image (854).png>)
...
![/bin/sh is at offset 0x17c968 from the start of libc](<../../../_assets/image (843).png>)
...
![/bin/sh inside vulnerable program is located at 0xb7f52968](<../../../_assets/image (844).png>)
...
![/bin/sh as an environment variable inside the vulnerable program at 0xBFFFFEF0](<../../../_assets/image (850).png>)
...
![/bin/sh can be seen in multiple locations in the vulnerable program](<../../../_assets/image (913).png>)
...
![Vulnerable program spawns a /bin/sh shell](<../../../_assets/image (842).png>)
...
![Once the vulnerable program is exploited, it spawns a /bin/sh](<../../../_assets/exploit-outside-gdb.gif>)
...
[source record](../../sources/redteamingtactics/return-to-libc.md)
