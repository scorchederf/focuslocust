...
![](<../../_assets/Annotation 2019-05-21 205403.png>)
...
```
![](<../../_assets/Annotation 2019-05-21 205633.png>)
...
![](<../../_assets/Annotation 2019-05-21 210027.png>)
...
![](<../../_assets/Annotation 2019-05-21 210541.png>)
...
sc.exe qc evilsvc
```
![](<../../_assets/Annotation 2019-05-21 210916.png>)
...
```
![](<../../_assets/Annotation 2019-05-21 211128.png>)
...
ls c:\
```
![](<../../_assets/Annotation 2019-05-21 211232.png>)
...
![](<../../_assets/Annotation 2019-05-21 211349.png>)

Since services usually run under `NT AUTHORITY\SYSTEM`, our malicious binary gets executed with `SYSTEM` privileges:

![](<../../_assets/Annotation 2019-05-21 212438.png>)
````

## Source Verification

[source record](../../sources/redteamingtactics/weak-service-permissions.md)
