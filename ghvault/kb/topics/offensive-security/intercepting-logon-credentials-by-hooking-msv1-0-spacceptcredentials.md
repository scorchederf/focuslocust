...
This lab was inspired by @\xpn\ and his great post https://blog.xpnsec.com/exploring-mimikatz-part-2/ - definitely go read it if you haven't.
...
![PSECPKG\_PRIMARY\_CRED structure and SpAcceptCredentials prototype](<../../_assets/image (449).png>)
...
![The signature will be passed on to the routine GetPatternMemoryAddress ](<../../_assets/image (463).png>)
...
![routine start before and after the hook was installed](<../../_assets/image (467).png>)

The first instructions of the hooked function now are:

![](<../../_assets/image (468).png>)
...
![](<../../_assets/image (471).png>)

and `jmp rax`:

![](<../../_assets/image (472).png>)
...
![](<../../_assets/msv1_0-spacceptcredentials-unhooking.gif>)
...
![](<../../_assets/msv1_0-spacceptcredentials.gif>)
...
[source record](../../sources/redteamingtactics/intercepting-logon-credentials-by-hooking-msv1-0-spacceptcredentials.md)
