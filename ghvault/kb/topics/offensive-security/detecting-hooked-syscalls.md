...
![Hooked and unhooked functions](<../../_assets/image (714).png>)
...
![Usual suspects hooked + some false positives](<../../_assets/image (717).png>)
...
[source record](../../sources/redteamingtactics/detecting-hooked-syscalls.md)
