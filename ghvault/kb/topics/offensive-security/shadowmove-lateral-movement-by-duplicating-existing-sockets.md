...
ShadowMove (original paper by researchers Amirreza Niakanlahiji, Jinpeng Wei, Md Rabbi Alam, Qingyang Wang and Bei-Tseng Chu, go check it for full details) is a late
...
![Source and Target hosts communicating using ShadowMove technique](<../../_assets/image (748).png>)
...
![Demo: ShadowMove Lateral Movement in Action](<../../_assets/shadowmove-lateral-movement (1).gif>)
...
[source record](../../sources/redteamingtactics/shadowmove-lateral-movement-by-duplicating-existing-sockets.md)
