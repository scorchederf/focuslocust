...
This is a quick lab to familiarize with a CursedChrome Chrome extension, which at a high level works in the following way:
...
![Source: https://github.com/mandatoryprogrammer/CursedChrome](<../../_assets/image (1072).png>)
...
![CursedChrome C2 server installed and configured](<../../_assets/image (1066).png>)
...
![CursedChrome installed in to Chrome](<../../_assets/image (1068).png>)
...
![CursedChrome web console.](<../../_assets/image (1067).png>)
...
![CursedChrome web panel, logged in.](<../../_assets/image (1069).png>)
...
![Installing CursedChrome CA Certificate to FireFox](<../../_assets/install-cert.gif>)
...
![ProxyFoxy configured to proxy traffic through the infected Chrome on a compromised computer](<../../_assets/image (1070).png>)
...
![Accessing Bitbucket via a compromised computer with CursedChrome extension installed on it](<../../_assets/image (1074).png>)
...
[source record](../../sources/redteamingtactics/man-in-the-browser-via-chrome-extension.md)
