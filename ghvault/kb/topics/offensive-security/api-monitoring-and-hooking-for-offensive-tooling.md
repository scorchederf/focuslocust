...
Rio recently posted about his tool RdpThief which I thought was plain genius. It allows for offensive o
...
![](<../../_assets/image (235).png>)

..we are prompted to enter credentials:

![RDP authentication prompt](<../../_assets/image (227).png>)
...
![CredIsMarshaledCredentialW contains the string spotless](<../../_assets/find-computername.gif>)

![CredIsMarshaledCredentialW contains the string spotless](<../../_assets/image (228).png>)
...
![ADVAPI32!CredIsMarshaledCredentialW breakpoint hit and username printed](<../../_assets/find-computername-windbg.gif>)

![ADVAPI32!CredIsMarshaledCredentialW breakpoint hit and username printed - still](<../../_assets/image (230).png>)
...
![Password not found in API Monitor when using search, although the password is clearly there](<../../_assets/image (244).png>)

![Plain text password visible in CryptUnprotectMemory](<../../_assets/image (239).png>)
...
![32 byte encrypted binary blob](<../../_assets/image (238).png>)
...
![](<../../_assets/capture-password.gif>)

![](<../../_assets/image (237).png>)
...
![](<../../_assets/inject-rdp-thief (1).gif>)
...
[source record](../../sources/redteamingtactics/api-monitoring-and-hooking-for-offensive-tooling.md)
