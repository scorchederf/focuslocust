...
![TEB, SEH Chains, SEH Records visualised](<../../../_assets/image (972).png>)
...
![Snippet of the \_TEB memory structure](<../../../_assets/image (973).png>)
...
![TIB memory structure in WinDBG](<../../../_assets/image (975).png>)
...
![SEH record memory structure \_EXCEPTION\_REGISTRATION\_RECORD ](<../../../_assets/image (976).png>)
...
![Head of SEH chain retrieved from the FS segment register fs:\[0\]](<../../../_assets/image (978).png>)
...
![Start of the SEH chain at 00cff274](<../../../_assets/image (979).png>)
...
![A bunch of jmp instructions in our seh-overflow.exe entry point](<../../../_assets/image (981).png>)
...
![Breakpoint hit at the Image Entry](<../../../_assets/image (982).png>)

Let's now see where the SEH head is at:

![SEH chain starts at 00bbfb2c](<../../../_assets/image (983).png>)
...
![0x00e220f0 is the 1st exception handler of seh-overflow.exe](<../../../_assets/image (985).png>)
...
![TEB / TIB / SEH chain with actual memory addresses](<../../../_assets/image (989).png>)
...
![RGUI showing up after launching it via xdbg](<../../../_assets/image (990).png>)
...
![Generating garbage data using python](<../../../_assets/image (991).png>)
...
![Sending garbage data to RGUI to confirm we can crash it and check if it's vulnerable to overflows](<../../../_assets/crashing-rgui.gif>)
...
![Program is vulnerable to a classic buffer overflow - EIP is overwritten](<../../../_assets/image (992).png>)
...
![Program confirmed to be vulnerable to SEH overflow - SEH record is overwrriten](<../../../_assets/image (994).png>)
...
![Payload structure high level view](<../../../_assets/image (1000).png>)
...
![Payload structure with offset to the SEH record](<../../../_assets/image (1010).png>)
...
![Confirming we can overwrite SEH record at 0141e768 ](<../../../_assets/image (1002).png>)
...
![SEH chain at time of the crash](<../../../_assets/image (1019).png>)
...
![Breakopoint hit at 76275680. 0141E768 is the SEH record we control and it's 3 values below the top of the stack](<../../../_assets/image (1005).png>)
...
![Finding pop pop ret instructions using byte pattern search in all modules](<../../../_assets/image (1006).png>)
...
![Breakpoint is set at 0x637412c8, it contains pop pop ret instructions](<../../../_assets/image (1007).png>)

### Overwriting SEH Record and Subverting Code Execution Flow

We now know that our payload should look like this:

![](<../../../_assets/image (1021).png>)
...
![Payload.txt contents](<../../../_assets/image (1008).png>)

Let's send that payload to the RGUI:

![Confirming we can subvert program's execution flow by overwriting SEH record](<../../../_assets/overwriting-seh-record-1 (1).gif>)
...
![Payload is organized in program's memory](<../../../_assets/image (1009).png>)
...
![Stack memory layout after the payload is sent to the program](<../../../_assets/image (1011).png>)

Below gif captures the full exploitation process:

![Confirming our SEH overflow exploit works](<../../../_assets/seh-overflow-exploit.gif>)
...
[source record](../../sources/redteamingtactics/seh-based-buffer-overflow.md)
