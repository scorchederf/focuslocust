...
Rushing to say that the tool Invoke-PowerCloud was heavily inspired by and based on the awesome work that Dominic Chell (@domchell
...
![](<../../_assets/Screenshot from 2018-10-15 22-11-03.png>)
...
![](<../../_assets/Screenshot from 2018-10-15 22-14-53.png>)
...
![](<../../_assets/Screenshot from 2018-10-15 22-16-20.png>)
...
![](<../../_assets/empire-stager-via-dns.gif>)
...
![](<../../_assets/Screenshot from 2018-10-16 20-12-57.png>)

Spike of `nslookup` for a host in a short amount of time:

![](<../../_assets/Screenshot from 2018-10-16 20-17-42.png>)
...
[source record](../../sources/redteamingtactics/powershell-payload-delivery-via-dns-using-invoke-powercloud.md)
