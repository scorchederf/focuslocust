...
This is a quick lab to get familiar with the process of writing and compiling shellcode in C and is merely a personal conspectus of the paper From a C project, through assembly, to shellcode
...
![Assembly instructions are generated based on the c-shellcode.asm](<../../_assets/image (688).png>)
...
![Comment out both includelib directives](<../../_assets/image (680).png>)
...
![notepad.exe executing shellcode that pops a MessageBox as seen in xdbg64](<../../_assets/pasting-executing-shellcode (1).gif>)
...
[source record](../../sources/redteamingtactics/writing-and-compiling-shellcode-in-c.md)
