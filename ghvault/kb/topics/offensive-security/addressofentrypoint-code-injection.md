...
![bytes at AddressOfEntryPoint get overwritten with shellcode](<../../_assets/overwrite-entrypoint.gif>)

Resuming the suspended process executes our shellcode which results in a meterpreter session:

![](<../../_assets/overwrite-entrypoint-catch-meterpreter.gif>)
...
[source record](../../sources/redteamingtactics/addressofentrypoint-code-injection.md)
