...
![Vulnerable program before and after its stack is overflowed with our malicious content](<../../../_assets/image (850).png>)
...
![After the crash, the program's EIP points to 778F54EE](<../../../_assets/observing-the-crash.gif>)

The application crashed and at this time, its Execution Instruction Pointer (EIP) points at `778F54EE`:

![After the crash, the program's EIP points to 778F54EE](<../../../_assets/image (793).png>)
...
![After the crash, the program's EIP points to 778F54EE, stack's content is being overwritten](<../../../_assets/image (818).png>)
...
![Getting closer to identifying the EIP offset](<../../../_assets/image (796).png>)
...
![EIP is overwritten and ESP points to the shellcode](<../../../_assets/image (799).png>)
...
![One step further to identifying the exact EIP offset](<../../../_assets/image (828).png>)
...
![Confirming EIP control at offset 268 and that shellcode is pointed to by the ESP](<../../../_assets/image (829).png>)
...
![Locating memory address that contains JMP ESP instruction](<../../../_assets/finding-jmp-esp.gif>)
...
![Python exploit skeleton confirmed that everything works as expected](<../../../_assets/image (823).png>)
...
![msfvenon generates shellcode for a tcp reverse shell](<../../../_assets/image (792).png>)
...
![Stack is overflowed and shellcode is executed, resulting in a reverse shell](<../../../_assets/executing-exploit.gif>)
...
![String of characters for identifying bad characters](<../../../_assets/image (830).png>)
...
![Testing for bad characters. A string of characters from 0x00-0xFF as a payload](<../../../_assets/image (824).png>)
...
![0xa0 is identified as a bad character](<../../../_assets/image (816).png>)
...
![Shellcode's bad characters getting encoded](<../../../_assets/image (815).png>)
...
[source record](../../sources/redteamingtactics/32-bit-stack-based-buffer-overflow.md)
