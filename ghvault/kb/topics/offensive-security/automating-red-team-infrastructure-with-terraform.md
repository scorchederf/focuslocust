...
The purpose of this lab was to get my hands dirty while building a simple, resilient and easily disposable red team infrastructure. Additionally, I wanted to play around with the the concept of Infrastructure as a Code, so I chose to tinker
...
![](<../../_assets/Screenshot from 2019-01-26 17-45-04.png>)
...
![](<../../_assets/Screenshot from 2019-01-26 18-13-38.png>)
...
![](<../../_assets/Screenshot from 2019-01-27 16-57-04.png>)

Additionally, `variables.tf` contains link to a password protected Cobalt Strike zip archive and the password itself:

![URL to a password protected Cobalt Strike zip](<../../_assets/Screenshot from 2019-01-29 22-32-07.png>)

![variables.tf showing my fake and misspelled password](<../../_assets/Screenshot from 2019-01-27 17-01-52.png>)
...
![](<../../_assets/Screenshot from 2019-01-29 22-31-08.png>)
...
![](<../../_assets/Screenshot from 2019-01-27 17-09-17.png>)
...
![C2 redirector IPs](<../../_assets/Screenshot from 2019-02-01 12-00-31.png>)

![C2 teamserver IPs](<../../_assets/Screenshot from 2019-02-01 12-00-22.png>)
...
![Cobalt Strike C2 & C2 redirector test](<../../_assets/Peek 2019-02-01 12-30.gif>)
...
![Successful C2 traffic redirection](<../../_assets/Screenshot from 2019-02-01 12-41-44.png>)
...
![](<../../_assets/Screenshot from 2019-01-27 17-10-47.png>)
...
![](<../../_assets/Screenshot from 2019-01-27 17-14-49.png>)
...
![](<../../_assets/Screenshot from 2019-01-29 21-58-25.png>)
...
.
```
![](<../../_assets/Screenshot from 2019-01-29 22-03-50.png>)
Daily report.eml
### Payload Redirector
...
![](<../../_assets/Screenshot from 2019-01-28 21-34-44.png>)

### Outputs

`Outputs.tf` contains key server DNS names and their IP addresses for operator's reference:

![](<../../_assets/Screenshot from 2019-01-28 21-50-22.png>)
...
![](<../../_assets/Screenshot from 2019-01-28 21-49-44.png>)
...
![](<../../_assets/Screenshot from 2019-01-29 21-17-16.png>)
...
[source record](../../sources/redteamingtactics/automating-red-team-infrastructure-with-terraform.md)
