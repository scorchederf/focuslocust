...
Sometimes it is possible to escalate privileges by abusing misconfigured services. Specifically, this is possible if path to the service binary is not wrapped in quotes and there are spaces in the path.. This stems from the way Windows hand
...
![](<../../_assets/Annotation 2019-05-20 221801.png>)
...
![](<../../_assets/Annotation 2019-05-20 222415.png>)
...
![](<../../_assets/vulnservice (1).gif>)
````

## Source Verification

[source record](../../sources/redteamingtactics/unquoted-service-paths.md)
