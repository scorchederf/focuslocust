...
The purpose of this lab was to play with syscalls once more. More specifically, the goal was to be able to retrieve ntdll syscall stubs from the disk during run-time (before AVs/EDRs get a chance to hook them), rather than hardcoding them,
...
![orange - syscall function name and its id, green - syscall stub](<../../_assets/image (552).png>)
...
![](<../../_assets/resolving-function-names.gif>)
...
![](<../../_assets/syscall-stub-found.gif>)
...
![](<../../_assets/calling-syscall-stub.gif>)
...
[source record](../../sources/redteamingtactics/retrieving-ntdll-syscall-stubs-from-disk-at-run-time.md)
