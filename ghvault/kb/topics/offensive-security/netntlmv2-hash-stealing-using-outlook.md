...
If a target system is not running the latest version of Windows/Outlook, it may be possible to craft such an email that allows an attacker to steal the victim's NetNTLMv2 hashes without requiring any interaction from the user - clicking the
...
![](<../../_assets/Screenshot from 2018-12-28 15-09-57.png>)

Select the malicious messge.html and select `Insert as Text`:

![](<../../_assets/Screenshot from 2018-12-28 15-11-07.png>)
...
![](<../../_assets/Screenshot from 2018-12-28 15-11-47.png>)
...
![](<../../_assets/Peek 2018-12-28 15-05.gif>)
...
![](<../../_assets/Screenshot from 2018-12-28 15-16-46.png>)
...
[source record](../../sources/redteamingtactics/netntlmv2-hash-stealing-using-outlook.md)
