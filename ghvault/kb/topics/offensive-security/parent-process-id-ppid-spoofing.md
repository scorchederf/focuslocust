...
PPID spoofing is a technique that allows attackers to start programs with arbitrary parent process set. This helps attackers make it look as if their programs were spawned by another process (instead of the one that would have spawned it if
...
![](<../../_assets/explorer-spawns-notepad.gif>)
...
![](<../../_assets/ppid-spoofing-notepad.gif>)
...
![](<../../_assets/ppid-spoofing-detection-etw.gif>)
...
[source record](../../sources/redteamingtactics/parent-process-id-ppid-spoofing.md)
