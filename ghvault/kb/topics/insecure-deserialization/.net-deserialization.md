...
.NET serialization is the process of converting an object’s state into a format that can be easily stored or transmitted, such as XML, JSON, or binary. This serialized data can then be saved to a file, sent over a network, or stored in a da
...
[source record](../../sources/payloadsallthethings/.net-deserialization.md)
