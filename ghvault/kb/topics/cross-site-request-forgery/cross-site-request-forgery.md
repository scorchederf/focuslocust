...
Cross-Site Request Forgery (CSRF/XSRF) is an attack that forces an end user to execute unwanted actions on a web application in which they're currently authenticated. CSRF attacks specifically target state-changing requests, not theft of da
...
[source record](../../sources/payloadsallthethings/cross-site-request-forgery.md)
