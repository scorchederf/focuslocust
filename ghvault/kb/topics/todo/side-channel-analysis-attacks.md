...
Side-channel attacks recover secrets by observing physical or micro-architectural "leakage" that is correlated with internal state but is not part of the logical interface of the device.  Examples range from measuring the instantaneous curr
...
[source record](../../sources/hacktricks/side-channel-analysis-attacks.md)
