...
This page covers how to extract entitlements from Mach-O binaries programmatically by walking LCCODESIGNATURE and parsing the code signing SuperBlob, and how to scale this across Apple IPSW firmwares by mounting and indexing their contents
...
[source record](../../sources/hacktricks/mach-o-entitlements-extraction-and-ipsw-indexing.md)
...
\ LC_CODE_SIGNATURE load command and placed in the __LINKEDIT segment. The signature is a CS_SuperBl...
```
