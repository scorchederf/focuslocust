...
Local AI command-line interfaces (AI CLIs) such as Claude Code, Gemini CLI, Codex CLI, Warp and similar tools often ship with powerful built‑ins: filesystem read/write, shell execution and outbound network access. Many act as MCP clients (M
...
[source record](../../sources/hacktricks/ai-agent-abuse-local-ai-cli-tools-and-mcp-claude-gemini-codex-warp.md)
