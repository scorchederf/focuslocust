...
Many commercial AI assistants now offer an "agent mode" that can autonomously browse the web in a cloud-hosted, isolated browser. When a login is required, built-in guardrails typically prevent the agent from entering credentials and instea
...
[source record](../../sources/hacktricks/ai-agent-mode-phishing-abusing-hosted-agent-browsers-ai-in-the-middle.md)
