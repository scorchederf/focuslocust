...
A homograph (aka homoglyph) attack abuses the fact that many Unicode code points from non-Latin scripts are visually identical or extremely similar to ASCII characters. By replacing one or more Latin characters with their look-alike counter
...
[source record](../../sources/hacktricks/homograph-homoglyph-attacks-in-phishing.md)
