...
Most modern Android phones embed a Broadcom/Cypress Wi-Fi chipset that ships without 802.11 monitor mode or frame-injection capabilities.  The open-source NexMon framework patches the proprietary firmware to add those features and exposes t
...
[source record](../../sources/hacktricks/enable-nexmon-monitor-mode-and-packet-injection-on-android-broadcom-chips.md)
