...
As previously commented, in order to try to enrol a device into an organization only a Serial Number belonging to that Organization is needed. Once the device is enrolled, several organizations will
...
[source record](../../sources/hacktricks/enrolling-devices-in-other-organisations.md)
