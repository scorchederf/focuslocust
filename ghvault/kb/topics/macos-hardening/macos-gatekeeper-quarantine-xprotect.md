...
Gatekeeper is a security feature developed for Mac operating systems, designed to ensure that users run only trusted software on their systems. It functions by validating software that a user downloads and attempts to open from sources outs
...
[source record](../../sources/hacktricks/macos-gatekeeper-quarantine-xprotect.md)
