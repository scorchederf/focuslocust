...
macOS TCC (Transparency, Consent, and Control) protects access to sensitive user data. When an attacker compromises a binary that already has TCC grants, they inherit those permissions. This page documents the exploitation potential of each
...
[source record](../../sources/hacktricks/macos-credential-and-data-theft-via-tcc-permissions.md)
