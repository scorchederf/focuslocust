...
- Daemon: User reserved for system daemons. The default daemon account names usually start with a "\":
...
[source record](../../sources/hacktricks/macos-users-and-external-accounts.md)
