...
The real entrypoint of a Mach-o binary is the dynamic linked, defined in LCLOADDYLINKER usually is /usr/lib/dyld.
...
[source record](../../sources/hacktricks/macos-dyld-process.md)
