...
Create a dylib with an interpose (DATAinterpose) section (or a section flagged with SINTERPOSING) containing tuples of function pointers that refer to the original and the replacement functions.
...
[source record](../../sources/hacktricks/macos-function-hooking.md)
