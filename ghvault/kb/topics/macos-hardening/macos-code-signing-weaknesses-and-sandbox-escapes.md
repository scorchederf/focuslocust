...
Ad-hoc signing (CSADHOC) creates a code signature with no certificate chain — it's a hash of the code with no developer identity verification. The binary's origin cannot be traced to any developer or organization.
...
[source record](../../sources/hacktricks/macos-code-signing-weaknesses-and-sandbox-escapes.md)
