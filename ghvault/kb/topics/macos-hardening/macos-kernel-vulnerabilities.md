...
In this report are explained several vulnerabilities that allowed to compromised the kernel compromising the software updater.\
...
[source record](../../sources/hacktricks/macos-kernel-vulnerabilities.md)
