...
MIG was created to simplify the process of Mach IPC code creation. It basically generates the needed code for server and client to communicate with a given definition. Even if the generated code is ugly, a developer will just need to import
...
[source record](../../sources/hacktricks/macos-mig-mach-interface-generator.md)
