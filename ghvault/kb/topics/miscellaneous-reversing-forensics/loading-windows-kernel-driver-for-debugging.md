...
![Stepping through driver's C code](<../../_assets/debugging-kernel-source-code.gif>)
````

## Source Verification

[source record](../../sources/redteamingtactics/loading-windows-kernel-driver-for-debugging.md)
