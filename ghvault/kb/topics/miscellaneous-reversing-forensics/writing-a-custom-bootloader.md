...
![512 bytes of bootloader in the 1st sector of a HDD](<../../_assets/image (782).png>)
...
![Our bootloader on the left and proper bootloader structure on the right](<../../_assets/image (789).png>)
...
![First valid bootloader running in Qemu](<../../_assets/emulate-bootloader.gif>)
...
![Source: https://www.cs.bham.ac.uk/\~exr/lectures/opsys/10\_11/lectures/os-dev.pdf](<../../_assets/image (769).png>)
...
![B character not displayed](<../../_assets/image (772).png>)
...
![B character is now displayed](<../../_assets/image (771).png>)
...
![Our bootloader in memory (left) and on disk (right)](<../../_assets/image (775).png>)
...
![Bootloader.bin bytes written to the boot sector of our USB key D:\\](<../../_assets/baking-bootloader-to-usb (2).gif>)
...
![Our bootloader running from a USB stick](<../../_assets/image (787).png>)
...
[source record](../../sources/redteamingtactics/writing-a-custom-bootloader.md)
