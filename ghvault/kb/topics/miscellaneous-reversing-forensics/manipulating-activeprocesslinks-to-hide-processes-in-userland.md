...
The purpose of this lab is to look into how Windows kernel rootkits hide / unlink \(or used to\) processes in the userland for utilities trying to list all running processes on the system such as Windows Task Manager, tasklist or Get-Proces
...
![notepad not seen when &quot;ps notepad&quot; is executed, although notepad is still running in the foreground](<../../_assets/image (467).png>)
...
[source record](../../sources/redteamingtactics/manipulating-activeprocesslinks-to-hide-processes-in-userland.md)
