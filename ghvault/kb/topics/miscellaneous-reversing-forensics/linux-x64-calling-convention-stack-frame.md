...
![Stack frame x64 inside the function test()](<../../_assets/image (891).png>)
...
![First argument (red) is now shifted by 0x10 on the stack and can be accessed via rbp - 0x14](<../../_assets/image (893).png>)

Based on the above case, the `test()` function stack frame, would now look like this:

![64-bit stack frame with 1 local variable defined inside the callee function](<../../_assets/image (890).png>)
...
![First argument is shifted by 0x10 once again and can be accessed via rbp - 0x24](<../../_assets/image (883).png>)
...
![First argument is shifted by 0x10 once again and can be accessed via rbp - 0x34](<../../_assets/image (884).png>)
...
![RDI and RSI registers inside main() contain argument count and argument values](<../../_assets/image (866).png>)
...
![](<../../_assets/image (906).png>)

Combining all the above knowledge, we can get a general view of the stack layout:

![Stack layout for 64-bit program on 64-bit Linux system](<../../_assets/image (911).png>)
...
[source record](../../sources/redteamingtactics/linux-x64-calling-convention-stack-frame.md)
