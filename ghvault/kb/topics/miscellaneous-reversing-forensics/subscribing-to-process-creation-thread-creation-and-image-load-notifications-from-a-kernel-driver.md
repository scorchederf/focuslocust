...
![](<../../_assets/PsSetCreateProcessNotifyRoutine.gif>)
...
![](<../../_assets/PsSetLoadImageNotifyRoutine.gif>)
...
[source record](../../sources/redteamingtactics/subscribing-to-process-creation-thread-creation-and-image-load-notifications-from-a-kernel-driver.md)
