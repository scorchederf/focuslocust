...
If enumerating a machine internally or externally you find Splunk running (port 8090), if you luckily know any valid credentials you can abuse the Splunk service to execute a shell as the user running Splunk. If root is running it, you can
...
[source record](../../sources/hacktricks/splunk-lpe-and-persistence.md)
