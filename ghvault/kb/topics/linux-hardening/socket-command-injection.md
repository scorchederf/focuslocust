...
In the following example a unix socket is created (/tmp/sockettest.s) and everything received is going to be executed by os.system.I know that you aren't going to find this in the wild, but the goal of this example is to see how a code usin
...
[source record](../../sources/hacktricks/socket-command-injection.md)
