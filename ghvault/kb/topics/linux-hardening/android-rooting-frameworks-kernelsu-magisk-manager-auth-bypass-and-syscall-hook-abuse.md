...
Rooting frameworks like KernelSU, APatch, SKRoot and Magisk frequently patch the Linux/Android kernel and expose privileged functionality to an unprivileged userspace "manager" app via a hooked syscall. If the manager-authentication step is
...
[source record](../../sources/hacktricks/android-rooting-frameworks-kernelsu-magisk-manager-auth-bypass-and-syscall-hook-abuse.md)
