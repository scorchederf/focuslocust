...
Namespaces are the kernel feature that makes a container feel like "its own machine" even though it is really just a host process tree. They do not create a new kernel and they do not virtualize everything, but they do let the kernel presen
...
[source record](../../sources/hacktricks/namespaces.md)
