...
This page documents a practical secure-boot break on multiple MediaTek platforms by abusing a verification gap when the device bootloader configuration (seccfg) is "unlocked". The flaw allows running a patched bl2ext at ARM EL3 to disable d
...
[source record](../../sources/hacktricks/mediatek-bl2-ext-secure-boot-bypass-el3-code-execution.md)
