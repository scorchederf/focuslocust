...
Active Directory Certificate Services (AD CS) is a Microsoft Windows server role that provides a public key infrastructure (PKI). It allows you to create, manage, and distribute digital certificates, which are used to secure communication a
...
[source record](../../sources/internalallthethings/active-directory-certificate-services.md)
