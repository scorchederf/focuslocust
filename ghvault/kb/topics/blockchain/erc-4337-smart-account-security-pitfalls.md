...
ERC-4337 account abstraction turns wallets into programmable systems. The core flow is validate-then-execute across a whole bundle: the EntryPoint validates every UserOperation before executing any of them. This ordering creates non-obvious
...
[source record](../../sources/hacktricks/erc-4337-smart-account-security-pitfalls.md)
