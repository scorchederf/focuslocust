...
If you have compromised a user account or a computer (machine account) that has kerberos constrained delegation enabled, it's possible to impersonate any domain user (including administrator) and authenticate to a service that the user acco
...
[source record](../../sources/redteamingtactics/kerberos-constrained-delegation.md)
