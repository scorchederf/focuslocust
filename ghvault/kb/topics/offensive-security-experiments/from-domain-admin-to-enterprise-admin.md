...
This lab is based on an Empire Case Study and its goal is to get more familiar with some of the concepts of Powershell Empire and its modules as well as Active Directory concepts suc
...
![](<../../_assets/domains-trusts-powershell.png>)
...
![](<../../_assets/domain-trust-conditional-forwarders.png>)

Adding a new trust by making `dc-mantvydas` a trusted domain:

![](<../../_assets/domain-trust-one-way-incoming.png>)

Setting the trust type to `Forest`:

![](<../../_assets/domain-trusts-forest.png>)

Incoming trust for `dc-mantvydas.offense.local` is now created:

![](<../../_assets/domain-trust-one-way-incoming-created.png>)

Testing nltest output:

![](<../../_assets/domain-trusts-nltest.png>)
...
![](<../../_assets/domain-trusts-notfound.png>)
...
![](<../../_assets/empire-dir-childdc.png>)
...
![](<../../_assets/empire-lateral-childdc.png>)

We now have the agent back, let's just confirm it:

![](<../../_assets/empire-childdc-recon.png>)
...
![](<../../_assets/empire-krbtgt-hash.png>)
...
![](<../../_assets/empire-golden-ticket.png>)
...
[source record](../../sources/redteamingtactics/from-domain-admin-to-enterprise-admin.md)
