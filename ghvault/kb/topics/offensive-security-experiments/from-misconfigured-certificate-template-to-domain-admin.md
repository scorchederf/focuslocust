...
This is a quick lab to familiarize with ECS1 privilege escalation technique, that illustrates how it's possible to elevate from a regular user to domain administrator in a Windows Domain by abusing over-permissioned Active Directory Certifi
...
![Vulnerable certificate template identified by Certify](<../../_assets/vuln-template.png>)
...
*   `PkiExtendedKeyUsage: Client Authentication`, which indicates that the certificate that will be generated based on this certificate template can be used to authenticate to computers in Active Directory.\
    ...
    ![](<../../_assets/client-authentication.png>)\
...
* `Enrollment Rights: NT Authority\Authenticated Users`, which indicates that any authenticated user in the Active Directory is **allowed to request** new certificates to be generated based on this certificate template.\
  \
  Below shows the same setting via GUI when inspecting certificate templates via `certsrv.msc`:\
  ![](<../../_assets/enroll-anyone (1) (1) (1).png>)
...
![New certificate was issued off of the vulnerable certificate template](<../../_assets/image (1086) (1) (1).png>)
...
![Using rubeus to request a TGT for a user for which we minted the certificate](<../../_assets/tgt-retrieved.png>)
...
![Listing a C$ share to confirm administrator access on a server](<../../_assets/testing-access.png>)
...
![Certificate Signing Request being generated with open ssl](<../../_assets/image (1082).png>)
...
![Requesting certificates via ADCS web self service portal](<../../_assets/image (1088) (1) (1).png>)

Click `advanced certificate request`:

![](<../../_assets/image (1083) (1).png>)
...
![Portal for submitting advanced certificate request](<../../_assets/image (1085) (1) (1) (1).png>)
...
[source record](../../sources/redteamingtactics/from-misconfigured-certificate-template-to-domain-admin.md)
