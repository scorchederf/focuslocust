...
This is a quick lab to familiarize with a technique called Shadow Credentials written about by Elad Shamir
...
![Everyone is allowed to write to SAC1$ computer account object](<../../_assets/image (1084).png>)
...
![Adding shadow credentials to sac1$ computer account](<../../_assets/image (1089) (1) (1).png>)
...
```
![SAC1$ with shadow credential set in the attribute msDS-KeyCredentialLink](<../../_assets/image (1089) (1).png>)
...
![Attempt to list c$ on the domain controller before shadow credentials attack - fail](<../../_assets/image (1088) (1).png>)
...
```
![Attempt to list c$ on the domain controller after shadow credentials attack - success](<../../_assets/image (1087) (1).png>)
...
![user-server2$ is over-permissioned and can be taken over by abusing Shadow Credentials](<../../_assets/image (1087).png>)
...
![TGT is retrieved for user-server2$](<../../_assets/image (1086).png>)
...
![Attempt to list c$ admin share fails](<../../_assets/image (1085) (1).png>)
...
![Computer Account Takeover with shadow credentials is successful](<../../_assets/image (1090) (1) (1).png>)
...
![S4U2Self - CIFS service requested TGS to itself on behalf of first\admin](<../../_assets/image (1090) (1).png>)
...
[source record](../../sources/redteamingtactics/shadow-credentials.md)
