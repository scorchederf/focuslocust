...
This is a quick lab to familiarize with a technique that allows accessing resources on a trusted domain from a fully compromised (Domain admin privileges achieved) trusting domain, by recovering the trusting account$ (that's present on the
...
![Technique / attack diagram based on the one seen in https://improsec.com/tech-blog/sid-filter-as-security-boundary-between-domains-part-7-trust-account-attack-from-trusting-to-trusted](<../../_assets/image (1088).png>)
...
[source record](../../sources/redteamingtactics/abusing-trust-account-accessing-resources-on-a-trusted-domain-from-a-trusting-domain.md)
