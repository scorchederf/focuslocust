...
This lab explores the Kerberoasting attack - it allows any domain user to request kerberos tickets from TGS that are encrypted with NTLM hash of the plaintext password of a domain user account that is used as a service account (i.e account
...
![](<../../_assets/kerberoast-principalname.png>)
...
```
![](<../../_assets/kerberoast-enumeration.png>)
...
![](<../../_assets/kerberoast-powershell.png>)
...
![](<../../_assets/kerberoast-setspn (1).png>)
...
![](<../../_assets/kerberoast-tgs-req.png>)
...
![](<../../_assets/kerberoast-tgs-res (1).png>)
...
```
![](<../../_assets/kerberoast-creating-keytab.png>)

Adding the keytab to wireshark:

![](<../../_assets/kerberoast-wireshark-keytab.png>)
...
![](<../../_assets/kerberoast-decrypted.png>)
...
![](<../../_assets/kerberoast-crackstation.png>)

![](<../../_assets/kerberoast-printstatements.png>)

I did not have to, but I also used an online RC4 decryptor tool to confirm the above findings:

![](<../../_assets/kerberoast-decryptedonline.png>)
kerberoast.pcap
## References
...
[source record](../../sources/redteamingtactics/kerberoasting.md)
