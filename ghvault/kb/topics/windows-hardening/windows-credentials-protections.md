...
The WDigest.aspx?f=255&MSPPError=-2147217396>) protocol, introduced with Windows XP, is designed for authentication via the HTTP Protocol and is enabled by default on Windows
...
[source record](../../sources/hacktricks/windows-credentials-protections.md)
