...
The creation of the MSI installer will be done using wixtools, specifically wixtools will be utilized. It is worth mentioning that alternative MSI builders were attempted, but they were not successful in this partic
...
[source record](../../sources/hacktricks/creating-malicious-msi-and-getting-root.md)
