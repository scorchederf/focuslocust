...
The following code from here. It allows to indicate a Process ID as argument and a CMD running as the user of the indicated process will be
...
[source record](../../sources/hacktricks/seimpersonate-from-high-to-system.md)
