...
Lansweeper is an IT asset discovery and inventory platform commonly deployed on Windows and integrated with Active Directory. Credentials configured in Lansweeper are used by its scanning engines to authenticate to assets over protocols lik
...
[source record](../../sources/hacktricks/lansweeper-abuse-credential-harvesting-secrets-decryption-and-deployment-rce.md)
