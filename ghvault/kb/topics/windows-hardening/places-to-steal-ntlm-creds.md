...
Check all the great ideas from https://osandamalith.com/2017/03/24/places-of-interest-in-stealing-netntlm-hashes/ from the download of a microsoft word fi
...
[source record](../../sources/hacktricks/places-to-steal-ntlm-creds.md)
