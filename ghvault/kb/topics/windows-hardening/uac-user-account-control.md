...
User Account Control (UAC) is a feature that enables a consent prompt for elevated activities. Applications have di
...
[source record](../../sources/hacktricks/uac-user-account-control.md)
