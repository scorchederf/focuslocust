...
By coercing a System Center Configuration Manager (SCCM) Management Point (MP) to authenticate over SMB/RPC and relaying that NTLM machine account to the site database (MSSQL) you obtain smsdbroleMP / smsdbroleMPUserSvc rights.  These roles
...
[source record](../../sources/hacktricks/sccm-management-point-ntlm-relay-to-sql-osd-policy-secret-extraction.md)
