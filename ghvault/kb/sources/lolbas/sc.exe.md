...
- Category: ADS
  Command: sc config {ExistingServiceName} binPath="\"c:\\ADS\\file.txt:cmd.exe\" /c echo works > \"c:\ADS\works.txt\"" &
    sc start {ExistingServiceName}
...
_source_path: /home/adams/scorchederf/focuslocust/.cache/lolbas/yml/OSBinaries/Sc.yml
```
