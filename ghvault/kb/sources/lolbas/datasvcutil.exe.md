...
- Category: Upload
  ...
  Usecase: Upload file
Created: 2020-12-01
Description: DataSvcUtil.exe is a command-line tool provided by WCF Data Services that consumes an Open Data Protocol (OData)
  feed and generates the client data service classes that are needed to access a data service from a .NET Framework client
  application.
Detection:
...
_source_path: /home/adams/scorchederf/focuslocust/.cache/lolbas/yml/OSBinaries/DataSvcUtil.yml
```
