...
- Category: Execute
  ...
  Description: Loads the specified DLL where DLL is configured with a 'MiniDumpCallbackRoutine' exported function. Valid process
    must be provided as dump still created.
  MitreID: T1202
...
_source_path: /home/adams/scorchederf/focuslocust/.cache/lolbas/yml/OtherMSBinaries/Procdump.yml
```
