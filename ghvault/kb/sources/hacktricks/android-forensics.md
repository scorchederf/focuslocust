...
- [Android Forensics](../../topics/todo/android-forensics.md)

## Extracted Fields

| Field | Value |
| --- | --- |
| id | hacktricks-todo-android-forensics |
| name | Android Forensics |
| type | hacktricks-topic |
| source | hacktricks |
| url | https://github.com/HackTricks-wiki/hacktricks/blob/master/src/todo/android-forensics.md |
...
_body: '# Android Forensics
  ...
  Create an [android backup using adb](../mobile-pentesting/android-app-pentesting/adb-commands.md#backup) and extract it
  using [Android Backup Extractor](https://sourceforge.net/projects/adbextractor/): `java -jar abe.jar unpack file.backup
  file.tar`
  ...
  - `cat /proc/partitions` (search the path to the flash memory, generally the first entry is _mmcblk0_ and corresponds to
  ...
  {{#include ../banners/hacktricks-training.md}}'
_relative_path: todo/android-forensics.md
_source_path: /home/adams/scorchederf/focuslocust/.cache/hacktricks/src/todo/android-forensics.md
```
