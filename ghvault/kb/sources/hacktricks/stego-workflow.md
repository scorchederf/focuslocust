...
| Record ID | `hacktricks-stego-workflow-readme` |
| Source file | `/home/adams/scorchederf/focuslocust/.cache/hacktricks/src/stego/workflow/README.md` |
| Parsed by | `focuslocust` |
| Relationship mode | `explicit / conservative inferred / manual` |

## Generated Concept Page

- [Stego Workflow](../../topics/stego/stego-workflow.md)

## Extracted Fields

| Field | Value |
| --- | --- |
| id | hacktricks-stego-workflow-readme |
| name | Stego Workflow |
| type | hacktricks-topic |
| source | hacktricks |
| url | https://github.com/HackTricks-wiki/hacktricks/blob/master/src/stego/workflow/README.md |

## Preserved Source Material

````yaml
_body: '# Stego Workflow
  ...
  If `file` and the extension disagree, trust `file`. Treat common formats as containers when appropriate (e.g., OOXML documents
  are ZIP files).
  ...
  These catch the high-frequency container-level cases: metadata payloads, appended bytes, and embedded files disguised by
  extension.
  ...
  {{#include ../../banners/hacktricks-training.md}}'
_relative_path: stego/workflow/README.md
_source_path: /home/adams/scorchederf/focuslocust/.cache/hacktricks/src/stego/workflow/README.md
````
