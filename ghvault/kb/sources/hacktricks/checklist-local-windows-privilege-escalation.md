...
| Record ID | `hacktricks-windows-hardening-checklist-windows-privilege-escalation` |
| Source file | `/home/adams/scorchederf/focuslocust/.cache/hacktricks/src/windows-hardening/checklist-windows-privilege-escalation.md` |
| Parsed by | `focuslocust` |
| Relationship mode | `explicit / conservative inferred / manual` |

## Generated Concept Page

- [Checklist - Local Windows Privilege Escalation](../../topics/windows-hardening/checklist-local-windows-privilege-escalation.md)

## Extracted Fields

| Field | Value |
| --- | --- |
| id | hacktricks-windows-hardening-checklist-windows-privilege-escalation |
| name | Checklist - Local Windows Privilege Escalation |
| type | hacktricks-topic |
| source | hacktricks |
| url | https://github.com/HackTricks-wiki/hacktricks/blob/master/src/windows-hardening/checklist-windows-privilege-escalation.md |

## Preserved Source Material

```yaml
_body: '# Checklist - Local Windows Privilege Escalation
  ...
  - [ ] Check if you have [any of these tokens enabled](windows-local-privilege-escalation/index.html#token-manipulation):
  **SeImpersonatePrivilege, SeAssignPrimaryPrivilege, SeTcbPrivilege, SeBackupPrivilege, SeRestorePrivilege, SeCreateTokenPrivilege,
  SeLoadDriverPrivilege, SeTakeOwnershipPrivilege, SeDebugPrivilege** ?

  - [ ] Check if you have [**SeManageVolumePrivilege**](windows-local-privilege-escalation/semanagevolume-perform-volume-maintenance-tasks.md)
  to read raw volumes and bypass file ACLs
  ...
  - [ ] [**Windows Vault**](windows-local-privilege-escalation/index.html#credentials-manager-windows-vault) credentials that
  you could use?
  ...
  - [ ] [**Remote Desktop Credentials Manager**](windows-local-privilege-escalation/index.html#remote-desktop-credential-manager)
  passwords?
  ...
  - [ ] If [**SeManageVolumePrivilege**](windows-local-privilege-escalation/semanagevolume-perform-volume-maintenance-tasks.md)
  is present, try raw-volume reads for `SAM`, `SYSTEM`, DPAPI material, and `MachineKeys`
  ...
  - [ ] Do you want to [**ask for credentials**](windows-local-privilege-escalation/index.html#ask-for-credentials) to the
  user?
  ...
  - [ ] [**Generic password search**](windows-local-privilege-escalation/index.html#generic-password-search-in-files-and-registry)
  in files and registry

  - [ ] [**Tools**](windows-local-privilege-escalation/index.html#tools-that-search-for-passwords) to automatically search
  for passwords
  ...
  {{#include ../banners/hacktricks-training.md}}'
_relative_path: windows-hardening/checklist-windows-privilege-escalation.md
_source_path: /home/adams/scorchederf/focuslocust/.cache/hacktricks/src/windows-hardening/checklist-windows-privilege-escalation.md
```
