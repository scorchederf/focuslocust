...
- [Control Panel Item](../../topics/offensive-security/control-panel-item.md)

## Extracted Fields

| Field | Value |
| --- | --- |
| id | rtt-offensive-security-code-execution-t1196-control-panel-item-code-execution |
| name | Control Panel Item |
| type | redteaming-topic |
| source | redteamingtactics |
| url | https://github.com/mantvydasb/RedTeaming-Tactics-and-Techniques/blob/master/offensive-security/code-execution/t1196-control-panel-item-code-execution.md |
...
_body: '---
  ...
  A quick look at the dissasembly of the dll suggests that rundll32.exe will be spawned, a new thread will be created in suspended
  mode, which most likely will get injected with our shellcode and eventually resumed to execute that shellcode:
  ...
  Note how rundll32 spawns cmd.exe and establishes a connection back to the attacker - these are signs that should raise your
  suspicion when investingating a host for a compromise:
...
_relative_path: offensive-security/code-execution/t1196-control-panel-item-code-execution.md
_source_path: /home/adams/scorchederf/focuslocust/.cache/redteaming-tactics-and-techniques/offensive-security/code-execution/t1196-control-panel-item-code-execution.md
````
