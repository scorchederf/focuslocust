...
| Source | `internalallthethings` |
| Type | `internal-topic` |
| Record ID | `iatt-cloud-azure-aka-ms` |
| Source file | `/home/adams/scorchederf/focuslocust/.cache/internalallthethings/docs/cloud/azure/aka-ms.md` |
| Parsed by | `focuslocust` |
| Relationship mode | `explicit / conservative inferred / manual` |

## Generated Concept Page

- [aka.ms Shortcuts](../../topics/cloud/aka.ms-shortcuts.md)

## Extracted Fields

| Field | Value |
| --- | --- |
| id | iatt-cloud-azure-aka-ms |
| name | aka.ms Shortcuts |
| type | internal-topic |
| source | internalallthethings |
| url | https://github.com/swisskyrepo/InternalAllTheThings/blob/main/docs/cloud/azure/aka-ms.md |

## Preserved Source Material

```yaml
_body: '# aka.ms Shortcuts


  aka.ms is a URL shortening service used by Microsoft. It is commonly employed to create short, easily shareable links that
  redirect users to longer or more complex URLs, typically related to Microsoft services, products, or resources.
...
_relative_path: cloud/azure/aka-ms.md
_source_path: /home/adams/scorchederf/focuslocust/.cache/internalallthethings/docs/cloud/azure/aka-ms.md
```
