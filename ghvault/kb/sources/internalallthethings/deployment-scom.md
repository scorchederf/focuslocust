...
| Source | `internalallthethings` |
| Type | `internal-topic` |
| Record ID | `iatt-active-directory-deployment-scom` |
| Source file | `/home/adams/scorchederf/focuslocust/.cache/internalallthethings/docs/active-directory/deployment-scom.md` |
| Parsed by | `focuslocust` |
| Relationship mode | `explicit / conservative inferred / manual` |

## Generated Concept Page

- [Deployment - SCOM](../../topics/active-directory/deployment-scom.md)

## Extracted Fields

| Field | Value |
| --- | --- |
| id | iatt-active-directory-deployment-scom |
| name | Deployment - SCOM |
| type | internal-topic |
| source | internalallthethings |
| url | https://github.com/swisskyrepo/InternalAllTheThings/blob/main/docs/active-directory/deployment-scom.md |

## Preserved Source Material

````yaml
_body: '# Deployment - SCOM


  > Microsoft SCOM (System Center Operations Manager) is a monitoring tool used to oversee the health and performance of servers,
  applications, and infrastructure in IT environments. It collects data from systems, generates alerts for issues, and provides
  dashboards and reports for administrators.
  ...
  * [nccgroup/SCOMDecrypt](https://github.com/nccgroup/SCOMDecrypt) - SCOMDecrypt is a tool to decrypt stored RunAs credentials
  from SCOM servers.
...
_relative_path: active-directory/deployment-scom.md
_source_path: /home/adams/scorchederf/focuslocust/.cache/internalallthethings/docs/active-directory/deployment-scom.md
````
