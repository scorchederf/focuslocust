...
- [Client Configurations](../../attack/techniques/T1592.004-client-configurations.md)
...
description: 'Adversaries may gather information about the victim''s client configurations that can be used during targeting.
  ...
  ATT ScanBox) Information about the client configurations may also be exposed to adversaries via online or other accessible
