...
description: '[Brute Ratel C4](https://attack.mitre.org/software/S1063) is a commercial red-teaming and adversarial attack
  ...
  MDSec Brute Ratel August 2022)(Citation: SANS Brute Ratel October 2022)(Citation: Trend Micro Black Basta October 2022)'
external_references:
- external_id: S1063
...
- description: Dark Vortex. (n.d.). A Customized Command and Control Center for Red Team and Adversary Simulation. Retrieved
    February 7, 2023.
  source_name: Dark Vortex Brute Ratel C4
  url: https://bruteratel.com/
- description: 'Harbison, M. and Renals, P. (2022, July 5). When Pentest Tools Go Brutal: Red-Teaming Tool Being Abused by
    Malicious Actors. Retrieved February 1, 2023.'
  source_name: Palo Alto Brute Ratel July 2022
  url: https://unit42.paloaltonetworks.com/brute-ratel-c4-tool/
- description: Kenefick, I. et al. (2022, October 12). Black Basta Ransomware Gang Infiltrates Networks via QAKBOT, Brute
    Ratel, and Cobalt Strike. Retrieved February 6, 2023.
...
- description: Thomas, W. (2022, October 5). Cracked Brute Ratel C4 framework proliferates across the cybercriminal underground.
...
modified: '2024-09-19T15:46:58.008Z'
name: Brute Ratel C4
object_marking_refs:
