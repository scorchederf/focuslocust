...
- [Firewall Enumeration](../../attack/data-sources/DC0044-firewall-enumeration.md)
...
| type | data-source |
| source | mitre |
| url | https://attack.mitre.org/datacomponents/DC0044 |
...
description: "Querying and extracting a list of available firewalls or their associated configurations and rules. This activity\
  ...
  \ Extracting firewall rules to identify “allow all” policies or rules that lack logging.\n- Enumerating with CLI Tools:\
  \ Using CLI commands like `gcloud compute firewall-rules list` to extract firewall settings in Google Cloud."
external_references:
- external_id: DC0044
