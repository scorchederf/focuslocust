...
- [Modify Authentication Process](../../attack/techniques/T1556-modify-authentication-process.md)
...
description: 'Adversaries may modify authentication mechanisms and processes to access user credentials or enable otherwise
  ...
  Compromised credentials or access may be used to bypass access controls placed on various resources on systems within the
  network and may even be used for persistent access to remote systems and externally available services, such as VPNs, Outlook
  Web Access and remote desktop.'
external_references:
- external_id: T1556
...
modified: '2026-04-16T20:07:52.977Z'
name: Modify Authentication Process
object_marking_refs:
