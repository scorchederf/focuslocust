...
- [Direct Volume Access](../../attack/techniques/T1006-direct-volume-access.md)
...
description: 'Adversaries may directly access a volume to bypass file access controls and file system monitoring. Windows
  ...
  to create shadow copies or backups of data from system volumes.(Citation: LOLBAS Esentutl)'
external_references:
- external_id: T1006
...
- description: Hakobyan, A. (2009, January 8). FDump - Dumping File Sectors Directly from Disk using Logical Offsets. Retrieved
    November 12, 2014.
...
- kill_chain_name: mitre-attack
  phase_name: stealth
modified: '2026-04-15T19:59:05.018Z'
name: Direct Volume Access
object_marking_refs:
