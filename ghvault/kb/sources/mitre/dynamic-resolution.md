...
- [Dynamic Resolution](../../attack/techniques/T1568-dynamic-resolution.md)
...
description: 'Adversaries may dynamically establish connections to command and control infrastructure to evade common detections
  ...
  command and control.(Citation: Talos CCleanup 2017)(Citation: FireEye POSHSPY April 2017)(Citation: ESET Sednit 2017 Activity)'
external_references:
- external_id: T1568
