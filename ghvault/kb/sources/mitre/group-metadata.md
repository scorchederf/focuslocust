...
- [Group Metadata](../../attack/data-sources/DC0105-group-metadata.md)
...
| type | data-source |
| source | mitre |
| url | https://attack.mitre.org/datacomponents/DC0105 |
...
description: "Group metadata includes attributes like name, permissions, purpose, and associated user accounts or roles, which\
  ...
  \ access (e.g., Windows Event ID 4662).\n- API Monitoring: Log API calls to modify group metadata (e.g., Microsoft Graph\
...
modified: '2025-10-21T15:14:39.577Z'
name: Group Metadata
object_marking_refs:
...
- enterprise-attack
x_mitre_log_sources:
- channel: Enumerate ACLs/role bindings
