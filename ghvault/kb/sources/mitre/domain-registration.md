...
- [Domain Registration](../../attack/data-sources/DC0101-domain-registration.md)
...
| type | data-source |
| source | mitre |
| url | https://attack.mitre.org/datacomponents/DC0101 |
...
description: "\"Domain Name: Domain Registration\" data component captures information about the assignment, ownership, and\
  ...
  \ domain restrictions or potential hijacking activity.\n- Name Server Information: Name servers point to a public DNS provider\
  \ often associated with malicious campaigns.\n- Privacy Protection: A domain uses WHOIS privacy protection to hide registrant\
  \ details.\n\nThis data component can be collected through the following measures:\n\n- WHOIS Services: Use tools or services\
  \ to perform WHOIS lookups:\n- WHOIS APIs: Automate domain registration lookups with APIs:\n- Registrar Platforms: Directly\
  \ query domain registrars (e.g., GoDaddy, Namecheap) for detailed registration data.\n- Threat Intelligence Platforms: Integrate\
  \ domain registration data from services like Recorded Future, RiskIQ, or PassiveTotal for enriched analysis."
external_references:
- external_id: DC0101
  source_name: mitre-attack
  url: https://attack.mitre.org/datacomponents/DC0101
id: x-mitre-data-component--ff9b665a-598b-4bcb-8b2a-a87566aa1256
modified: '2025-10-21T15:14:40.288Z'
name: Domain Registration
object_marking_refs:
...
- channel: None
  name: Domain Name
- channel: Excessive lookups for domains with suspicious WHOIS or short TTL values
  name: dns:query
- channel: DNS lookups resolving to domains with rapid changes in registration metadata
  name: esxi:vmkernel
