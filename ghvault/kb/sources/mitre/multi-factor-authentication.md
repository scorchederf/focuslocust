...
- [Multi-factor Authentication](../../attack/mitigations/M1032-multi-factor-authentication.md)
...
description: 'Multi-Factor Authentication (MFA) enhances security by requiring users to provide at least two forms of verification
  ...
  access. This mitigation can be implemented through the following measures:


  Identity and Access Management (IAM):


  - Use IAM solutions like Azure Active Directory, Okta, or AWS IAM to enforce MFA policies for all user logins, especially
  ...
  - Enable Conditional Access policies to only allow logins from trusted devices, such as those enrolled in Intune or joined
  via Hybrid/Entra.
  ...
  - Use authenticator applications such as Google Authenticator, Microsoft Authenticator, or Authy for time-based one-time
  passwords (TOTP).
  ...
  - Enforce policies that require MFA on all critical systems, especially for remote access, privileged accounts, and cloud
  applications.'
external_references:
- external_id: M1032
...
modified: '2025-05-09T15:48:18.053Z'
name: Multi-factor Authentication
object_marking_refs:
